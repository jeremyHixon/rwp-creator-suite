        ...
        const uploadInterface = `
            <div class="blk-upload-container">
                <div class="blk-upload-zone" id="upload-zone">
                    ...
                    <h3 class="blk-upload-title">${this.config.strings.uploadPrompt || 'Upload Instagram Data'}</h3>
    ...
    createResultsHTML(data) {
        ...
        return `
            ...
            <div class="blk-results-body">
                ${this.config.isLoggedIn ? this.createFullResults(data) : this.createTeaserResults(data)}
            </div>
        ...
        return `
            <div class="blk-full-results">
                <div class="blk-section-header">
                    <h3>Accounts Not Following You Back (${data.stats.notFollowingBackCount})</h3>
            ...
            <div class="blk-account-item ${isWhitelisted ? 'blk-account-item--whitelisted' : ''}" data-username="${account.username}">
                ...
                <div class="blk-account-actions">
                    ${this.config.isLoggedIn ? `
                        <button class="blk-button blk-button--small ${isWhitelisted ? 'blk-button--secondary' : ''} blk-whitelist-btn" data-username="${account.username}">
            ...
            <div class="blk-teaser-results">
                <div class="blk-teaser-overlay">
                    <div class="blk-teaser-content">
                        ...
                        <p>You found <strong>${data.stats.notFollowingBackCount}</strong> accounts that don't follow you back!</p>
                        <div class="blk-teaser-benefits">
                            <div class="blk-benefit-item">
                                <span class="blk-benefit-icon">✅</span>
                                <span>See all ${data.stats.notFollowingBackCount} account names</span>
                            </div>
                            <div class="blk-benefit-item">
                                <span class="blk-benefit-icon">✅</span>
                ...
                <div class="blk-teaser-preview">
                    <h3>Preview: First ${sampleCount} of ${data.stats.notFollowingBackCount} accounts</h3>
                    <div class="blk-accounts-list blk-accounts-list--blurred">
                        ${this.createTeaserAccountItems(data.notFollowingBack.slice(0, sampleCount))}
                        ${hiddenCount > 0 ? `
    ...
    createTeaserAccountItems(accounts) {
        return accounts.map(account => `
            <div class="blk-account-item blk-account-item--preview">
                <div class="blk-account-avatar"></div>
                <div class="blk-account-info">
                    <div class="blk-account-username">${this.maskUsername(account.username)}</div>
                </div>
                <div class="blk-account-actions">
