...
class RWPEnhancedStateManager extends RWPStateManager {
    ...
    saveGuestState() {
        ...
        try {
            ...
            localStorage.setItem(this.guestStorageKey, JSON.stringify(dataToStore));
        } catch (error) {
    ...
    filterGuestSafeData(state) {
        ...
        const sensitiveKeys = ['user', 'private', 'secret', 'token', 'auth', 'password'];
        const safestateMap = {};
...
class RWPCaptionWriterStateManager extends RWPEnhancedStateManager {
    constructor(initialState = {}) {
        ...
        super('caption_writer', { ...defaultState, ...initialState }, {
            guestPersistence: true,
    ...
    filterGuestSafeData(state) {
        ...
        const safeFields = [
            'description', 'platforms', 'tone', 'finalCaption', 
            'activeTab', 'characterCount'
        ];
...
class RWPContentRepurposerStateManager extends RWPEnhancedStateManager {
    constructor(initialState = {}) {
        ...
        super('content_repurposer', { ...defaultState, ...initialState }, {
            guestPersistence: true,
    ...
    filterGuestSafeData(state) {
        ...
        const safeFields = [
            'content', 'platforms', 'tone', 'showUsageStats'
        ];
