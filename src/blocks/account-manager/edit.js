			...
			<InspectorControls>
				...
				>
					<SelectControl
						...
						options={ [
							{
								label: __( 'Dashboard', 'rwp-creator-suite' ),
								value: 'dashboard',
							},
							{
								label: __(
						...
						help={ __(
							'Select which view to display by default',
							'rwp-creator-suite'
						) }
					/>
					...
					<ToggleControl
						...
						onChange={ ( value ) =>
							setAttributes( { showConsentSettings: value } )
						}
						help={ __(
					...
					<ToggleControl
						...
						onChange={ ( value ) =>
							setAttributes( { allowGuestView: value } )
						}
						help={ __(
							'Show registration/login prompt for non-logged-in users',
							'rwp-creator-suite'
						) }
					/>
				</PanelBody>
					...
					<div className="rwp-account-manager-preview">
						...
						<div className="tab-content">
							...
							{ viewType === 'consent' && showConsentSettings && (
								<p>
									{ __(
										'Advanced analytics consent management',
										'rwp-creator-suite'
									) }
								</p>
							) }
