...
// Generate unique ID for this instance with fallback
$unique_id = function_exists('wp_unique_id') ? 
    wp_unique_id( 'rwp-caption-writer-' ) : 
    'rwp-caption-writer-' . uniqid();
...
$wrapper_attributes = get_block_wrapper_attributes( array(
    ...
    'data-config' => esc_attr( wp_json_encode( array(
        ...
        // User state will be determined client-side for cacheability
    ) ) ),
) );
?>
...
<div <?php echo $wrapper_attributes; ?>>
    <div class="caption-writer-app">
        ...
        <div class="caption-writer-tabs">
            ...
            <button class="tab-button" data-tab="favorites" style="display: none;">
        ...
        <!-- Favorites Tab -->
        <div class="tab-content" data-content="favorites" style="display: none;">
