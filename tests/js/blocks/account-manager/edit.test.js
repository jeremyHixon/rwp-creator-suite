...
describe( 'Account Manager Block Edit Component', () => {
	...
	test( 'should render placeholder with correct label', () => {
		...
		const placeholder = container.querySelector(
			'[data-testid="account-manager-placeholder"]'
		);
	...
	test( 'should render with correct CSS classes', () => {
		...
		const blockElement = container.querySelector(
			'.rwp-account-manager-block-isolation'
		);
		expect( blockElement ).toBeDefined();
		expect( blockElement.getAttribute( 'data-view-type' ) ).toBe(
			'dashboard'
		);
